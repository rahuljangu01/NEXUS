...
// Get all of the current user's connections with last message and unread count
const getMyConnections = async (req, res) => {
  try {
    ...
    const connections = await Connection.find({
      ...
      .populate({ path: "users", select: "name department profilePhotoUrl isOnline" })
      .populate({ path: "requestedBy", select: "name department profilePhotoUrl isOnline" })
      .lean();
